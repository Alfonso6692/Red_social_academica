...
public class ServicioRecursos {
     ...
     */
    public void subirRecurso(String titulo, String descripcion, String nombreArchivo, String tipoArchivo, Usuario usuario) throws SQLException {
     ...
     * @throws SQLException Si hay un error de base de datos.
     */
    public List<Recurso> obtenerTodosLosRecursos() throws SQLException {
